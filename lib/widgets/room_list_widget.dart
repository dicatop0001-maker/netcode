...
class RoomListWidget extends StatefulWidget {
  ...
  @override State<RoomListWidget> createState() => _RoomListWidgetState();
}
...
class _RoomListWidgetState extends State<RoomListWidget> {
  ...
  void _load() => setState(() => _rooms = StorageService.getAllRooms());
  ...
  Widget build(BuildContext context) {
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (_, i) {
          final r = _rooms[i];
          final t = RoomType.values.where((t) => t.name == r.type)
              .firstOrNull ?? RoomType.geral;
