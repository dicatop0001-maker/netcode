...
class MessageModelAdapter extends TypeAdapter<MessageModel> {
  ...
  MessageModel read(BinaryReader reader) {
    ...
    return MessageModel(
      ...
      senderNick: fields[3] as String,
      text: fields[4] as String,
      createdAt: fields[5] as DateTime,
      expiresAt: fields[6] as DateTime,
      imagePath: fields[7] as String?,
      forwarded: fields[8] as bool,
      seenBy: (fields[9] as List).cast<String>(),
      audioPath: fields[10] as String?,
      messageType: fields[11] as String? ?? 'text',
  ...
  void write(BinaryWriter writer, MessageModel obj) {
    writer
      ...
      ..writeByte(1)..write(obj.roomId)
      ..writeByte(2)..write(obj.senderId)
      ..writeByte(3)..write(obj.senderNick)
      ..writeByte(4)..write(obj.text)
      ..writeByte(5)..write(obj.createdAt)
      ..writeByte(6)..write(obj.expiresAt)
      ..writeByte(7)..write(obj.imagePath)
      ..writeByte(8)..write(obj.forwarded)
      ..writeByte(9)..write(obj.seenBy)
      ..writeByte(10)..write(obj.audioPath)
      ..writeByte(11)..write(obj.messageType)
      ..writeByte(12)..write(obj.recipientId);
  }
